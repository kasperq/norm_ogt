...
type
  TDM1 = class(TDataModule)
    ...
    P_RashifDAT_PRIX: TDateField;
    P_RashifVC: TIntegerField;
    P_RashifPR_REG: TIntegerField;
    P_RashifSNG: TIntegerField;
...
begin
  ...
  mem_sumRashRazd.LoadFromDataSet(sumRash_Razd, [mtcpoAppend]);
  mem_sumRashRazd.First;
