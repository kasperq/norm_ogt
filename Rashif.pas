...
uses
  ...
  IBQuery,DateUtils, rxSplshWnd,RxMemDS, rxPlacemnt, rxFileUtil, rxToolEdit, RxIBQuery,
  Menus, IniFiles, kbmMemTable, DBGridEhGrouping, ToolCtrlsEh, System.UITypes,
...
//    rashifColsSetsIni : TIniFile;
    ...
    procedure calcKurs;
    procedure prosmotrFromArchive;
    procedure prosmotrCurrentRashif;
...
begin
  ...
  try
    ...
    if (not DM1.IBQuery1.Eof) then
      prosmotrCurrentRashif  // из Normn
    else
      prosmotrFromArchive;  // из архива
    dm1.Rashif.EnableControls;
  except
    on e : exception do
    begin
...
procedure TFRashif.prosmotrCurrentRashif;
begin
...
procedure TFRashif.prosmotrFromArchive;
begin
  DM1.NormArx.Close;
